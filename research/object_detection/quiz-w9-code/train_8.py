...
###################### the first x2 on logits and element wise merging  ####################
...
# Perform the upsampling x2 on logits
...
###################### the sencond x2 on upsampled_logits_x2 and element wise merging ####################
...
# Perform the upsampling x2 on upsampled_logits_x2
upsample_filter_np_x2_x2 = bilinear_upsample_weights(2, number_of_classes)

upsample_filter_tensor_x2_x2 = tf.Variable(upsample_filter_np_x2_x2, name='vgg_16/fc8/t_conv_x2_x2')

upsampled_logits_x2_x2 = tf.nn.conv2d_transpose(upsampled_logits_x2, upsample_filter_tensor_x2_x2,
                                          output_shape=tf.shape(aux_logits_32s),
                                          strides=[1, 2, 2, 1],
                                          padding='SAME')


upsampled_logits_x2_x2 = upsampled_logits_x2_x2 + aux_logits_32s

###################### x8 on upsampled_logits_x4 = x32 ####################
upsample_filter_np_x8 = bilinear_upsample_weights(upsample_factor,
                                                   number_of_classes)

upsample_filter_tensor_x8 = tf.Variable(upsample_filter_np_x8, name='vgg_16/fc8/t_conv_x8')
upsampled_logits = tf.nn.conv2d_transpose(upsampled_logits_x2_x2, upsample_filter_tensor_x8,
